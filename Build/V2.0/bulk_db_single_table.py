    ...
    for root, dirs, files in os.walk(startpath):
            ...
            try:
                ...
                if extension == "html":
                    with open(file_path, 'r', encoding='utf-8') as file:
                        txt = str(file.read())
                        insert_info_tuple(db_connection, [(file_name, file_path, file_size, extension, creation_time, last_modified_time, txt)])
                else:
                    insert_info_tuple(db_connection, [(file_name, file_path, file_size, extension, creation_time, last_modified_time, None)])
        ...
        for dir in dirs:
            try:
                ...
                insert_info_tuple(db_connection, [(dir_name, dir_path, dir_size, "Directory", creation_time, last_modified_time, None)])
            except Exception as e:
                continue
    db_reference.close()
